                ...
                VStack(spacing: 14) {
                    ...
                    if !isPast || workoutPlan != nil {
                        WorkoutPlanSection(
                            ...
                            onPlanWithRena:   { renaContext = isToday ? "workout_plan" : "plan:\(dateString)"; showRena = true },
                            onOpenRena:       { renaContext = isToday ? "update_workout_plan" : "plan:\(dateString)"; showRena = true },
