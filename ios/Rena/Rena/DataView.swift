        ...
        NavigationView {
            ScrollView {
                VStack(spacing: 20) {
                    // Progress rings
                    HStack(spacing: 16) {
                        StatRing(value: appState.caloriesConsumed, total: appState.caloriesTarget, label: "Calories", color: Color(hex: "E76F51"))
                        StatRing(value: appState.waterGlasses, total: 8, label: "Water", color: Color(hex: "457B9D"))
                    }
                    .padding()
                    ...
                    NavigationLink(destination: ScanView()) {
                        HStack(spacing: 14) {
                            ...
                            VStack(alignment: .leading, spacing: 2) {
                                ...
                                Text("Use your camera to log a meal")
                                    .font(.caption)
...
// MARK: - Shared subviews used by DataView
